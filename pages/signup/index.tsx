  ...
  return (
    <div>
      ...
      <div className="sm:w-[600px] w-full sm:px-[60px] sm:py-[40px] m-auto flex justify-center flex-col sm:border sm:shadow-xl sm:rounded-2xl">
        <p className="font-bold text-xxl text-gray-1 mb-[48px] text-center">
          회원가입
        </p>
        <div className="w-full flex flex-col gap-[20px] text-md">
          <div className="w-full text-md text-gray-1">
